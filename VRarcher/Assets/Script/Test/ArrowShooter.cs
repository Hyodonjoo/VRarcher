...
public class ArrowShooter : MonoBehaviour
{
	...
	{
		Quaternion rotation = arrowSpawnPoint.rotation * Quaternion.Euler(rotationAngleX, rotationAngleY, rotationAngleZ);
		...
		if (rb != null)
		{
			rb.velocity = arrowInstance.transform.forward * arrowSpeed;
		}
	}
}
